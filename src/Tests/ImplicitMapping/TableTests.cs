...
namespace Tests.ImplicitMapping
{
    ...
    public class ImplicitlyMappedTableTests
    {
        ...
        public void Setup()
        {
            ...
            const string dataColumns = "name, hide, [timestamp], nameenum, valueenum";
            const string data = "'oh hai', 0, GETDATE(), 'Second', 3";
            ...
            _database.AddTable("[id] [int] IDENTITY(1,1) NOT NULL, [name] [nvarchar] (500) NULL, " + 
                ...
                5, "name, hide, nameenum, valueenum", "'oh hai yo', 1, 'Second', 3");
