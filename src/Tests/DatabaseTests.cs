...
namespace Tests
{
    ...
    public class DatabaseTests
    {
        ...
        {
            var results = Gribble.Database.Create(Database.Connection, TimeSpan.FromMinutes(5), MappingCollection, Profiler).CallProcedureMany<Entity>("GetAll").ToList();
        ...
        {
            var result = Gribble.Database.Create(Database.Connection, TimeSpan.FromMinutes(5), MappingCollection, Profiler).CallProcedureSingle<Entity>("GetOne", new Dictionary<string, object> { { "Id", 5 } });
        ...
        {
            var result = Gribble.Database.Create(Database.Connection, TimeSpan.FromMinutes(5), MappingCollection, Profiler).CallProcedureScalar<int>("GetCount");
        ...
        {
            Gribble.Database.Create(Database.Connection, TimeSpan.FromMinutes(5), MappingCollection, Profiler).CallProcedure("DeleteOne", new Dictionary<string, object> { { "Id", 6 } });
        ...
        {
            var tableName = "Temp" + Guid.NewGuid().ToString("N");
            Gribble.Database.Create(Database.Connection, TimeSpan.FromMinutes(5), MappingCollection, Profiler).CreateTable(tableName,
        ...
        public void Drop_Table_Test()
        {
            ...
            Gribble.Database.Create(Database.Connection, TimeSpan.FromMinutes(5), MappingCollection, Profiler).DeleteTable(tableName);
        ...
        public void Add_Column_Test()
        {
            ...
            Gribble.Database.Create(Database.Connection, TimeSpan.FromMinutes(5), MappingCollection, Profiler).AddColumn(tableName, 
                                    new Column("Name", typeof(string), isNullable: true, length: 500));
        ...
        public void Drop_Column_Test()
        {
            ...
            Gribble.Database.Create(Database.Connection, TimeSpan.FromMinutes(5), MappingCollection, Profiler).RemoveColumn(tableName, "Name");
        ...
        public void Add_Index_Test()
        {
            ...
            Gribble.Database.Create(Database.Connection, TimeSpan.FromMinutes(5), MappingCollection, Profiler).AddNonClusteredIndex(tableName, "Name", "Created");
        ...
        public void Drop_Index_Test()
        {
            ...
            Gribble.Database.Create(Database.Connection, TimeSpan.FromMinutes(5), MappingCollection, Profiler).RemoveNonClusteredIndex(tableName, string.Format("IX_{0}_Name_Created", tableName));
