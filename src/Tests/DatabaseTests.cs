...
namespace Tests
{
    ...
    public class DatabaseTests
    {
        ...
        public void Setup()
        {
            ...
            GribbleDatabase = Gribble.Database.Create(Database.Connection, MappingCollection, profiler: Profiler);
        }
        ...
        public void should_create_table()
        {
            ...
            Gribble.Database.Create(Database.Connection, MappingCollection, profiler: Profiler).CreateTable(tableName,
        ...
        public void should_create_table_from_template()
        {
            ...
            var database = Gribble.Database.Create(Database.Connection, MappingCollection, profiler: Profiler);
