    ...
    public class SchemaTests
    {
        ...
        public void Create_Table_Identity_Test()
        {
            var statement = SchemaWriter.CreateTableCreateStatement(TableName, 
                                    ...
                                    new Column { Name = "Uid", Type = typeof(Guid), IsAutoGenerated = true },
                                    new Column { Name = "Name", Type = typeof(string), IsNullable = true, Length = 500 },
                                    new Column { Name = "Created", Type = typeof(DateTime), IsNullable = false, IsAutoGenerated = true });
            statement.Result.ShouldEqual(Statement.ResultType.None);
        ...
        {
            var statement = SchemaWriter.CreateAddColumnStatement(TableName, new Column { Name = "Created", Type = typeof(DateTime), IsNullable = false, IsAutoGenerated = true });
            statement.Result.ShouldEqual(Statement.ResultType.None);
